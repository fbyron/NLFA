...
\textsc{\Huge Nichtlineare Funktionalanalysis }\\[0.5cm]
\textsc{\Large Luis Felipe Müller} \\[1cm]

\hrule \hspace*{1cm}\\[3mm]
{\sc Kompletter Mitschrieb zur gleichnamigen Vorlesung im Sommersemester 2011\\
    \hspace*{1cm}\hfill}\\
    \hrule
    \vspace{1cm}
