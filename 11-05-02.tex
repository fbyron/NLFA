...
\begin{proof}
    ...
    \begin{proof}
        ...
        \]
        Mit dem Proposition $\ref{2.7}$ a) folgt die Behauptung. \[  \]
    \end{proof}
...
Auch hier die Idee: Sei $f\in D_y(\ol \Omega, \R^n)$. Wir schuen $\tilde f \in C^2 (\ol \Omega, \R^n)$
...
\begin{proof}
    \begin{description}
        ...
        $y\in \RV (f) \, \Ra \, f^{-1}(y)=\{x\}_{i=1}^N$. Mithilfe des \textit{satzes über die 
            ...
            \]
            Wir können (zumindest auf evtl. noch kleineren $U^i(x^i)$) annehmen, dass das Vorzeihcen
...
\begin{theorem}[Existenz und Eindeutigkeit des Brower'schen Abbildungsgrades]\label{2.11}
    ...
    \[\deg(f,\Omega,y)\]
    mit den Eigenschaften \textbf{(D1-D4)}. Weiter gilt
    \[
